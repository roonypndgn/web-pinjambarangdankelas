    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <form action="{{ route('pengembalian.destroy', $k->id) }}" method="POST" style="display:inline-block">
            @csrf
            @method('DELETE')
...
<div class="modal fade" id="modalTambah" tabindex="-1">
  <div class="modal-dialog">
    <form action="{{ route('pengembalian.store') }}" method="POST" class="modal-content">
      @csrf
...
<div class="modal fade" id="modalEdit{{ $k->id }}" tabindex="-1">
  <div class="modal-dialog">
    <form action="{{ route('pengembalian.update', $k->id) }}" method="POST" class="modal-content">
      @csrf
      @method('PUT')
      <div class="modal-header">
